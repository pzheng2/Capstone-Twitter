      ...
      <div>
        <span className="rating">
          ...
          <label onMouseOver={ this._onMouseOver } onMouseOut={ this._onMouseOut }
            htmlFor="rating-input-1-5" className="rating-star">{ "Eek! Methinks not." }</label>

          <input type="radio" onClick={ this.props.updateRating }
            className="rating-input" id="rating-input-1-4" name="rating-input-1"/>
          <label onMouseOver={ this._onMouseOver } onMouseOut={ this._onMouseOut }
            htmlFor="rating-input-1-4" className="rating-star">{ "Meh. I've had better."}</label>
          ...
          <label onMouseOver={ this._onMouseOver } onMouseOut={ this._onMouseOut }
            htmlFor="rating-input-1-2" className="rating-star">{ "Yay! I'm a fan."}</label>

          <input type="radio" onClick={ this.props.updateRating }
            className="rating-input" id="rating-input-1-1" name="rating-input-1"/>
          <label onMouseOver={ this._onMouseOver } onMouseOut={ this._onMouseOut }
            htmlFor="rating-input-1-1" className="rating-star">{ "Woohoo! As good as it gets!"}</label>
        </span>
